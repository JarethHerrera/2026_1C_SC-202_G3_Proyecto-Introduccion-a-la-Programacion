...
public class VentanaServicios extends JFrame {
    ...
    JLabel lblInfo = new JLabel("Ingrese el numero de tiquete (Ej: TK1001)");
    ...
    private void initComponents() {
        ...
        // dos pestanias: menu especial y compras
    ...
    private JPanel crearTabMenu() {
        ...
        JLabel desc = new JLabel(
            "<html><center>Seleccione el tipo de menu para este pasajero.<br>"
            + "Quedara guardado en el tiquete para la tripulacion.</center></html>");
