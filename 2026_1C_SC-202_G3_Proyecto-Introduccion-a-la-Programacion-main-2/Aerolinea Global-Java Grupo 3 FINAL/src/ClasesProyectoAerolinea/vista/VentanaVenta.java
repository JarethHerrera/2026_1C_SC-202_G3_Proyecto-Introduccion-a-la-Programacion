...
public class VentanaVenta extends JFrame {
    ...
    private void initComponents() {
        ...
        // ---- PANEL SUPERIOR: seleccion de vuelo ----
        ...
        // ---- PANEL DERECHO: datos del pasajero ----
        ...
        formPas.add(new JLabel("ID/Cedula:"));   formPas.add(txtId);
        formPas.add(new JLabel(""));              formPas.add(btnBuscar);
        formPas.add(new JLabel("Nombre:"));       formPas.add(txtNombre);
        formPas.add(new JLabel("Apellido:"));     formPas.add(txtApellido);
        formPas.add(new JLabel("Email:"));        formPas.add(txtEmail);
        formPas.add(new JLabel("Nivel Socio:"));  formPas.add(cmbNivel);
    ...
    private void dibujarMapa(Avion avion) {
        ...
        for (int i = 0; i < totalFilas; i++) {
            ...
            if (i == avion.getFilasPrimera() || i == avion.getFilasPrimera() + avion.getFilasEjecutiva()) {
                gbc.gridy = filaVisual; gbc.gridx = 0; gbc.gridwidth = cols + 1;
            ...
            // numero de fila
            gbc.gridy = filaVisual; gbc.gridx = 0;
    ...
    private void comprarTiquete() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            // refrescar mapa y limpiar formulario
            cargarMapa();
            limpiarForm();
        }
    }

    // limpia el formulario del pasajero
