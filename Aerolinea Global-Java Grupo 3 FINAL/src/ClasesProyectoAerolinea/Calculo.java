...
public class Calculo {
    ...
    private void inicializarCatalogo() {
        catalogo[cantProductos++] = new Comida("Perfume Blue De Chanel", "DutyFree", 120.00);
        catalogo[cantProductos++] = new Comida("Perfume Dior Sauvage", "DutyFree", 100.00);
        catalogo[cantProductos++] = new Comida("Airpods", "Electronica", 120.00);
        catalogo[cantProductos++] = new Comida("Cargador De Laptop", "Electronica", 35.00);
        catalogo[cantProductos++] = new Comida("Agua", "Bebida", 2.50);
        catalogo[cantProductos++] = new Comida("Jugo de naranja", "Bebida", 4.00);
        catalogo[cantProductos++] = new Comida("Big cola", "Bebida", 3.00);
