...
public class VentanaFlota extends JFrame {
    ...
    JTextField txtFecha = new JTextField("2026-4-14");
    ...
    private void initComponents() {
        // dos pestanas: una para aviones, otra para vuelos
    ...
    private JPanel crearTabAviones() {
        ...
        form.add(txtModelo);
        form.add(new JLabel("Filas 1ra Clase:"));
        form.add(txtFilasPrimera);
        form.add(new JLabel("Filas Ejecutiva:"));
        form.add(txtFilasEjec);
        form.add(new JLabel("Filas Economica:"));
        form.add(txtFilasEcon);
        form.add(new JLabel("Columnas:"));
        form.add(txtColumnas);
        ...
        // panel izquierdo: registrar + registro
    ...
    private JPanel crearTabVuelos() {
        ...
        form.add(new JLabel("Codigo Vuelo:"));
        form.add(txtCodVuelo);
        form.add(new JLabel("Avion:"));
        form.add(cmbAviones);
    ...
    private void dibujarAvion(Avion avion) {
        ...
        JPanel canvas = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // Colores de clase y si esta ocupado o no
